...
*/var qh,pi,Pr,xc,Vi,$h,yc,Cy=function(){return typeof window<"u"},ei={},Oi=180/Math.PI,Lr=Math.PI/180,vr=Math.atan2,Kh=1e8,Mc=/([A-Z])/g,Ry=/(left|right|width|margin|padding|x)/i,Py=/[\s,\(]\S/,Cn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Nl=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Ly=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Dy=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},Iy=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Fd=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Bd=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},Uy=function(t,e,n){return t.style[e]=n},Ny=function(t,e,n){return t.style.setProperty(e,n)},Oy=function(t,e,n){return t._gsap[e]=n},Fy=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},By=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},zy=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},oe="transform",Xe=oe+"Origin",ky=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in ei&&s){if(this.tfm=this.tfm||{},t!=="transform")t=Cn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=$n(i,o)}):this.tfm[t]=a.x?a[t]:$n(i,t),t===Xe&&(this.tfm.zOrigin=a.zOrigin);else return Cn.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(oe)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Xe,e,"")),t=oe}(s||e)&&this.props.push(t,e,s[t])},zd=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},Vy=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Mc,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=yc(),(!s||!s.isStart)&&!n[oe]&&(zd(n),i.zOrigin&&n[Xe]&&(n[Xe]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},kd=function(t,e){var n={target:t,props:[],revert:Vy,save:ky};return t._gsap||Ye.core.getCache(t),e&&e.split(",").forEach(function(i){return n.save(i)}),n},Vd,Ol=function(t,e){var n=pi.createElementNS?pi.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):pi.createElement(t);return n&&n.style?n:pi.createElement(t)},Ln=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Mc,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,Gr(e)||e,1)||""},Zh="O,Moz,ms,Ms,Webkit".split(","),Gr=function(t,e,n){var i=e||Vi,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(Zh[a]+t in s););return a<0?null:(a===3?"ms":a>=0?Zh[a]:"")+t},Fl=function(){Cy()&&window.document&&(qh=window,pi=qh.document,Pr=pi.documentElement,Vi=Ol("div")||{style:{}},Ol("div"),oe=Gr(oe),Xe=oe+"Origin",Vi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Vd=!!Gr("perspective"),yc=Ye.core.reverting,xc=1)},Fo=function r(t){var e=Ol("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if(Pr.appendChild(e),e.appendChild(this),this.style.display="block",t)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),Pr.removeChild(e),this.style.cssText=s,a},Jh=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Hd=function(t){var e;try{e=t.getBBox()}catch{e=Fo.call(t,!0)}return e&&(e.width||e.height)||t.getBBox===Fo||(e=Fo.call(t,!0)),e&&!e.width&&!e.x&&!e.y?{x:+Jh(t,["x","cx","x1"])||0,y:+Jh(t,["y","cy","y1"])||0,width:0,height:0}:e},Gd=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Hd(t))},Zi=function(t,e){if(e){var n=t.style,i;e in ei&&e!==Xe&&(e=oe),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(Mc,"-$1").toLowerCase())):n.removeAttribute(e)}},mi=function(t,e,n,i,s,a){var o=new We(t._pt,e,n,0,1,a?Bd:Fd);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},jh={deg:1,rad:1,turn:1},Hy={grid:1,flex:1},Si=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Vi.style,l=Ry.test(e),c=t.tagName.toLowerCase()==="svg",h=(c?"client":"offset")+(l?"Width":"Height"),u=100,d=i==="px",p=i==="%",g,_,m,f;if(i===a||!s||jh[i]||jh[a])return s;if(a!=="px"&&!d&&(s=r(t,e,n,"px")),f=t.getCTM&&Gd(t),(p||a==="%")&&(ei[e]||~e.indexOf("adius")))return g=f?t.getBBox()[l?"width":"height"]:t[h],de(p?s/g*u:s/100*g);if(o[l?"width":"height"]=u+(d?a:i),_=~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,f&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===pi||!_.appendChild)&&(_=pi.body),m=_._gsap,m&&p&&m.width&&l&&m.time===Qe.time&&!m.uncache)return de(s/m.width*u);if(p&&(e==="height"||e==="width")){var x=t.style[e];t.style[e]=u+i,g=t[h],x?t.style[e]=x:Zi(t,e)}else(p||a==="%")&&!Hy[Ln(_,"display")]&&(o.position=Ln(t,"position")),_===t&&(o.position="static"),_.appendChild(Vi),g=Vi[h],_.removeChild(Vi),o.position="absolute";return l&&p&&(m=Hi(_),m.time=Qe.time,m.width=_[h]),de(d?g*s/u:g&&s?u/g*s:0)},$n=function(t,e,n,i){var s;return xc||Fl(),e in Cn&&e!=="transform"&&(e=Cn[e],~e.indexOf(",")&&(e=e.split(",")[0])),ei[e]&&e!=="transform"?(s=Es(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:Oa(Ln(t,Xe))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Na[e]&&Na[e](t,e,n)||Ln(t,e)||sd(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?Si(t,e,s,n)+n:s},Gy=function(t,e,n,i){if(!n||n==="none"){var s=Gr(e,t,1),a=s&&Ln(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=Ln(t,"borderTopColor"))}var o=new We(this._pt,t.style,e,0,1,Ud),l=0,c=0,h,u,d,p,g,_,m,f,x,v,y,C;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(_=t.style[e],t.style[e]=i,i=Ln(t,e)||i,_?t.style[e]=_:Zi(t,e)),h=[n,i],Td(h),n=h[0],i=h[1],d=n.match(Sr)||[],C=i.match(Sr)||[],C.length){for(;u=Sr.exec(i);)m=u[0],x=i.substring(l,u.index),g?g=(g+1)%5:(x.substr(-5)==="rgba("||x.substr(-5)==="hsla(")&&(g=1),m!==(_=d[c++]||"")&&(p=parseFloat(_)||0,y=_.substr((p+"").length),m.charAt(1)==="="&&(m=Rr(p,m)+y),f=parseFloat(m),v=m.substr((f+"").length),l=Sr.lastIndex-v.length,v||(v=v||en.units[e]||y,l===i.length&&(i+=v,o.e+=v)),y!==v&&(p=Si(t,e,_,v)||0),o._pt={_next:o._pt,p:x||c===1?x:",",s:p,c:f-p,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?Bd:Fd;return Qu.test(i)&&(o.e=0),this._pt=o,o},Qh={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Wy=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=Qh[n]||n,e[1]=Qh[i]||i,e.join(" ")},Xy=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],ei[o]&&(l=1,o=o==="transformOrigin"?Xe:oe),Zi(n,o);l&&(Zi(n,oe),a&&(a.svg&&n.removeAttribute("transform"),Es(n,1),a.uncache=1,zd(i)))}},Na={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new We(t._pt,e,n,0,0,Xy);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},Ss=[1,0,0,1,0,0],Wd={},Xd=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},tu=function(t){var e=Ln(t,oe);return Xd(e)?Ss:e.substr(7).match(ju).map(de)},Sc=function(t,e){var n=t._gsap||Hi(t),i=t.style,s=tu(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Ss:s):(s===Ss&&!t.offsetParent&&t!==Pr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent)&&(c=1,o=t.nextElementSibling,Pr.appendChild(t)),s=tu(t),l?i.display=l:Zi(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):Pr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Bl=function(t,e,n,i,s,a){var o=t._gsap,l=s||Sc(t,!0),c=o.xOrigin||0,h=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,p=l[0],g=l[1],_=l[2],m=l[3],f=l[4],x=l[5],v=e.split(" "),y=parseFloat(v[0])||0,C=parseFloat(v[1])||0,b,A,R,M;n?l!==Ss&&(A=p*m-g*_)&&(R=y*(m/A)+C*(-_/A)+(_*x-m*f)/A,M=y*(-g/A)+C*(p/A)-(p*x-g*f)/A,y=R,C=M):(b=Hd(t),y=b.x+(~v[0].indexOf("%")?y/100*b.width:y),C=b.y+(~(v[1]||v[0]).indexOf("%")?C/100*b.height:C)),i||i!==!1&&o.smooth?(f=y-c,x=C-h,o.xOffset=u+(f*p+x*_)-f,o.yOffset=d+(f*g+x*m)-x):o.xOffset=o.yOffset=0,o.xOrigin=y,o.yOrigin=C,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[Xe]="0px 0px",a&&(mi(a,o,"xOrigin",c,y),mi(a,o,"yOrigin",h,C),mi(a,o,"xOffset",u,o.xOffset),mi(a,o,"yOffset",d,o.yOffset)),t.setAttribute("data-svg-origin",y+" "+C)},Es=function(t,e){var n=t._gsap||new Cd(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=Ln(t,Xe)||"0",h,u,d,p,g,_,m,f,x,v,y,C,b,A,R,M,S,L,z,O,H,W,V,Y,G,ht,pt,ft,Ct,Ht,X,Q;return h=u=d=_=m=f=x=v=y=0,p=g=1,n.svg=!!(t.getCTM&&Gd(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[oe]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[oe]!=="none"?l[oe]:"")),i.scale=i.rotate=i.translate="none"),A=Sc(t,n.svg),n.svg&&(n.uncache?(G=t.getBBox(),c=n.xOrigin-G.x+"px "+(n.yOrigin-G.y)+"px",Y=""):Y=!e&&t.getAttribute("data-svg-origin"),Bl(t,Y||c,!!Y||n.originIsAbsolute,n.smooth!==!1,A)),C=n.xOrigin||0,b=n.yOrigin||0,A!==Ss&&(L=A[0],z=A[1],O=A[2],H=A[3],h=W=A[4],u=V=A[5],A.length===6?(p=Math.sqrt(L*L+z*z),g=Math.sqrt(H*H+O*O),_=L||z?vr(z,L)*Oi:0,x=O||H?vr(O,H)*Oi+_:0,x&&(g*=Math.abs(Math.cos(x*Lr))),n.svg&&(h-=C-(C*L+b*O),u-=b-(C*z+b*H))):(Q=A[6],Ht=A[7],pt=A[8],ft=A[9],Ct=A[10],X=A[11],h=A[12],u=A[13],d=A[14],R=vr(Q,Ct),m=R*Oi,R&&(M=Math.cos(-R),S=Math.sin(-R),Y=W*M+pt*S,G=V*M+ft*S,ht=Q*M+Ct*S,pt=W*-S+pt*M,ft=V*-S+ft*M,Ct=Q*-S+Ct*M,X=Ht*-S+X*M,W=Y,V=G,Q=ht),R=vr(-O,Ct),f=R*Oi,R&&(M=Math.cos(-R),S=Math.sin(-R),Y=L*M-pt*S,G=z*M-ft*S,ht=O*M-Ct*S,X=H*S+X*M,L=Y,z=G,O=ht),R=vr(z,L),_=R*Oi,R&&(M=Math.cos(R),S=Math.sin(R),Y=L*M+z*S,G=W*M+V*S,z=z*M-L*S,V=V*M-W*S,L=Y,W=G),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,f=180-f),p=de(Math.sqrt(L*L+z*z+O*O)),g=de(Math.sqrt(V*V+Q*Q)),R=vr(W,V),x=Math.abs(R)>2e-4?R*Oi:0,y=X?1/(X<0?-X:X):0),n.svg&&(Y=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Xd(Ln(t,oe)),Y&&t.setAttribute("transform",Y))),Math.abs(x)>90&&Math.abs(x)<270&&(s?(p*=-1,x+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,x+=x<=0?180:-180)),e=e||n.uncache,n.x=h-((n.xPercent=h&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-h)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-u)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=de(p),n.scaleY=de(g),n.rotation=de(_)+o,n.rotationX=de(m)+o,n.rotationY=de(f)+o,n.skewX=x+o,n.skewY=v+o,n.transformPerspective=y+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[Xe]=Oa(c)),n.xOffset=n.yOffset=0,n.force3D=en.force3D,n.renderTransform=n.svg?qy:Vd?Yd:Yy,n.uncache=0,n},Oa=function(t){return(t=t.split(" "))[0]+" "+t[1]},Bo=function(t,e,n){var i=De(e);return de(parseFloat(e)+parseFloat(Si(t,"x",n+"px",i)))+i},Yy=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Yd(t,e)},Di="0deg",ts="0px",Ii=") ",Yd=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,h=n.rotationY,u=n.rotationX,d=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,f=n.force3D,x=n.target,v=n.zOrigin,y="",C=f==="auto"&&t&&t!==1||f===!0;if(v&&(u!==Di||h!==Di)){var b=parseFloat(h)*Lr,A=Math.sin(b),R=Math.cos(b),M;b=parseFloat(u)*Lr,M=Math.cos(b),a=Bo(x,a,A*M*-v),o=Bo(x,o,-Math.sin(b)*-v),l=Bo(x,l,R*M*-v+v)}m!==ts&&(y+="perspective("+m+Ii),(i||s)&&(y+="translate("+i+"%, "+s+"%) "),(C||a!==ts||o!==ts||l!==ts)&&(y+=l!==ts||C?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Ii),c!==Di&&(y+="rotate("+c+Ii),h!==Di&&(y+="rotateY("+h+Ii),u!==Di&&(y+="rotateX("+u+Ii),(d!==Di||p!==Di)&&(y+="skew("+d+", "+p+Ii),(g!==1||_!==1)&&(y+="scale("+g+", "+_+Ii),x.style[oe]=y||"translate(0, 0)"},qy=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,h=n.skewY,u=n.scaleX,d=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,f=n.yOffset,x=n.forceCSS,v=parseFloat(a),y=parseFloat(o),C,b,A,R,M;l=parseFloat(l),c=parseFloat(c),h=parseFloat(h),h&&(h=parseFloat(h),c+=h,l+=h),l||c?(l*=Lr,c*=Lr,C=Math.cos(l)*u,b=Math.sin(l)*u,A=Math.sin(l-c)*-d,R=Math.cos(l-c)*d,c&&(h*=Lr,M=Math.tan(c-h),M=Math.sqrt(1+M*M),A*=M,R*=M,h&&(M=Math.tan(h),M=Math.sqrt(1+M*M),C*=M,b*=M)),C=de(C),b=de(b),A=de(A),R=de(R)):(C=u,R=d,b=A=0),(v&&!~(a+"").indexOf("px")||y&&!~(o+"").indexOf("px"))&&(v=Si(p,"x",a,"px"),y=Si(p,"y",o,"px")),(g||_||m||f)&&(v=de(v+g-(g*C+_*A)+m),y=de(y+_-(g*b+_*R)+f)),(i||s)&&(M=p.getBBox(),v=de(v+i/100*M.width),y=de(y+s/100*M.height)),M="matrix("+C+","+b+","+A+","+R+","+v+","+y+")",p.setAttribute("transform",M),x&&(p.style[oe]=M)},$y=function(t,e,n,i,s){var a=360,o=Ae(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?Oi:1),c=l-i,h=i+c+"deg",u,d;return o&&(u=s.split("_")[1],u==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),u==="cw"&&c<0?c=(c+a*Kh)%a-~~(c/a)*a:u==="ccw"&&c>0&&(c=(c-a*Kh)%a-~~(c/a)*a)),t._pt=d=new We(t._pt,e,n,i,c,Ly),d.e=h,d.u="deg",t._props.push(n),d},eu=function(t,e){for(var n in e)t[n]=e[n];return t},Ky=function(t,e,n){var i=eu({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,h,u,d,p,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[oe]=e,o=Es(n,1),Zi(n,oe),n.setAttribute("transform",c)):(c=getComputedStyle(n)[oe],a[oe]=e,o=Es(n,1),a[oe]=c);for(l in ei)c=i[l],h=o[l],c!==h&&s.indexOf(l)<0&&(p=De(c),g=De(h),u=p!==g?Si(n,l,c,g):parseFloat(c),d=parseFloat(h),t._pt=new We(t._pt,o,l,u,d-u,Nl),t._pt.u=g||0,t._props.push(l));eu(o,i)};Ge("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});Na[t>1?"border"+r:r]=function(o,l,c,h,u){var d,p;if(arguments.length<4)return d=a.map(function(g){return $n(o,g,c)}),p=d.join(" "),p.split(d[0]).length===5?d[0]:p;d=(h+"").split(" "),p={},a.forEach(function(g,_){return p[g]=d[_]=d[_]||d[(_-1)/2|0]}),o.init(l,p,u)}});var qd={name:"css",register:Fl,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,h,u,d,p,g,_,m,f,x,v,y,C,b,A,R;xc||Fl(),this.styles=this.styles||kd(t),R=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(h=e[_],!(Je[_]&&Rd(_,e,n,i,t,s)))){if(p=typeof h,g=Na[_],p==="function"&&(h=h.call(n,i,t,s),p=typeof h),p==="string"&&~h.indexOf("random(")&&(h=xs(h)),g)g(this,t,_,h,n)&&(A=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),h+="",yi.lastIndex=0,yi.test(c)||(m=De(c),f=De(h)),f?m!==f&&(c=Si(t,_,c,f)+f):m&&(h+=m),this.add(o,"setProperty",c,h,i,s,0,0,_),a.push(_),R.push(_,0,o[_]);else if(p!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],Ae(c)&&~c.indexOf("random(")&&(c=xs(c)),De(c+"")||c==="auto"||(c+=en.units[_]||De($n(t,_))||""),(c+"").charAt(1)==="="&&(c=$n(t,_))):c=$n(t,_),d=parseFloat(c),x=p==="string"&&h.charAt(1)==="="&&h.substr(0,2),x&&(h=h.substr(2)),u=parseFloat(h),_ in Cn&&(_==="autoAlpha"&&(d===1&&$n(t,"visibility")==="hidden"&&u&&(d=0),R.push("visibility",0,o.visibility),mi(this,o,"visibility",d?"inherit":"hidden",u?"inherit":"hidden",!u)),_!=="scale"&&_!=="transform"&&(_=Cn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),v=_ in ei,v){if(this.styles.save(_),y||(C=t._gsap,C.renderTransform&&!e.parseTransform||Es(t,e.parseTransform),b=e.smoothOrigin!==!1&&C.smooth,y=this._pt=new We(this._pt,o,oe,0,1,C.renderTransform,C,0,-1),y.dep=1),_==="scale")this._pt=new We(this._pt,C,"scaleY",C.scaleY,(x?Rr(C.scaleY,x+u):u)-C.scaleY||0,Nl),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){R.push(Xe,0,o[Xe]),h=Wy(h),C.svg?Bl(t,h,0,b,0,this):(f=parseFloat(h.split(" ")[2])||0,f!==C.zOrigin&&mi(this,C,"zOrigin",C.zOrigin,f),mi(this,o,_,Oa(c),Oa(h)));continue}else if(_==="svgOrigin"){Bl(t,h,1,b,0,this);continue}else if(_ in Wd){$y(this,C,_,d,x?Rr(d,x+h):h);continue}else if(_==="smoothOrigin"){mi(this,C,"smooth",C.smooth,h);continue}else if(_==="force3D"){C[_]=h;continue}else if(_==="transform"){Ky(this,h,t);continue}}else _ in o||(_=Gr(_)||_);if(v||(u||u===0)&&(d||d===0)&&!Py.test(h)&&_ in o)m=(c+"").substr((d+"").length),u||(u=0),f=De(h)||(_ in en.units?en.units[_]:m),m!==f&&(d=Si(t,_,c,f)),this._pt=new We(this._pt,v?C:o,_,d,(x?Rr(d,x+u):u)-d,!v&&(f==="px"||_==="zIndex")&&e.autoRound!==!1?Iy:Nl),this._pt.u=f||0,m!==f&&f!=="%"&&(this._pt.b=c,this._pt.r=Dy);else if(_ in o)Gy.call(this,t,_,c,x?x+h:h);else if(_ in t)this.add(t,_,c||t[_],x?x+h:h,i,s);else if(_!=="parseTransform"){hc(_,h);continue}v||(_ in o?R.push(_,0,o[_]):R.push(_,1,c||t[_])),a.push(_)}}A&&Nd(this)},render:function(t,e){if(e.tween._time||!yc())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:$n,aliases:Cn,getSetter:function(t,e,n){var i=Cn[e];return i&&i.indexOf(",")<0&&(e=i),e in ei&&e!==Xe&&(t._gsap.x||$n(t,"x"))?n&&$h===n?e==="scale"?Fy:Oy:($h=n||{})&&(e==="scale"?By:zy):t.style&&!oc(t.style[e])?Uy:~e.indexOf("-")?Ny:gc(t,e)},core:{_removeProperty:Zi,_getMatrix:Sc}};Ye.utils.checkPrefix=Gr;Ye.core.getStyleSaver=kd;(function(r,t,e,n){var i=Ge(r+","+t+","+e,function(s){ei[s]=1});Ge(t,function(s){en.units[s]="deg",Wd[s]=1}),Cn[i[13]]=r+","+t,Ge(n,function(s){var a=s.split(":");Cn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Ge("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){en.units[r]="px"});Ye.registerPlugin(qd);var nn=Ye.registerPlugin(qd)||Ye;nn.core.Tween;const Kr=new sc;Kr.hide();let _a=0,ga=[],$d=[],Ec=[],Wr,Xr,Ya,ve,vn,Tr,va,zl,Yr=!1,kl,Fa;const Et={materialColor:"#ffeded",animationSpeed:.5,framePadding:.05},Zy=document.querySelector("canvas.webgl"),sn=new Pv({color:"tan"}),Jy=new In(2,2,1,1),Kd=new Qn({transparent:!0,uniforms:{uAlpha:{value:1}},vertexShader:`
    ...
    `}),jy=new Ee(Jy,Kd);sn.add(jy);function Qy(){const r=new In(100,100),t=new Ca({color:16777215}),e=new Ee(r,t);e.receiveShadow=!0,e.rotation.y=Math.PI/2,e.position.x=-.25,sn.add(e)}Qy();const Zd=new mx("#ffffff",.5);Zd.position.set(1,1,0);sn.add(Zd);const tM=10,eM=7.8,nM=.4,iM=.3,rM=.33,Ne=new fx("#ffffff",tM,eM,nM,iM,rM);Ne.position.set(-.5,1,0);Ne.castShadow=!0;Ne.shadow.mapSize.width=1024;Ne.shadow.mapSize.height=1024;sn.add(Ne);sn.add(Ne.target);const ii=Kr.addFolder("Spotlight Position");ii.add(Ne,"intensity",0,100).name("Intensity");ii.add(Ne,"distance",0,100).name("Distance");ii.add(Ne,"angle",0,Math.PI/2).name("Angle");ii.add(Ne,"penumbra",0,5).name("Penumbra");ii.add(Ne,"decay",0,5).name("Decay");ii.add(Ne.position,"x",-10,10).name("X Position");ii.add(Ne.position,"y",-10,10).name("Y Position");ii.add(Ne.position,"z",-10,10).name("Z Position");ii.open();new Yu;let ne={width:window.innerWidth,height:window.innerHeight};function Jd(){const r=jt.position.z,t=vi.degToRad(jt.fov);ne.viewportHeight=2*Math.tan(t/2)*r;const e=window.innerWidth/window.innerHeight;ne.viewportWidth=ne.viewportHeight*e;const n=jt.position.x-ne.viewportWidth/2,i=jt.position.x+ne.viewportWidth/2;console.log(`Viewport distance: ${r} units`),console.log(`Viewport width: ${ne.viewportWidth} units`),console.log(`Viewport height: ${ne.viewportHeight} units`),console.log(`Left x/z coordinates: ${n}`),console.log(`Right x/z coordinates: ${i}`)}function jd(r,t,e){const n=e/100,i=vi.degToRad(jt.fov),s=window.innerWidth/window.innerHeight,a=r/(2*n*s)/Math.tan(i/2),o=t/(2*n)/Math.tan(i/2),l=Math.max(a,o);return console.log(`Required distance from camera: ${l} units`),l}window.addEventListener("resize",()=>{ne.width=window.innerWidth,ne.height=window.innerHeight,jt.aspect=ne.width/ne.height,jt.updateProjectionMatrix(),Jd(),Ji.setSize(ne.width,ne.height),Ji.setPixelRatio(Math.min(window.devicePixelRatio,2)),Et.wireLength=Qd(),_a=0,tf()});const ni=new Sn;sn.add(ni);const jt=new je(50,ne.width/ne.height,.1,100);jt.position.z=6;ni.add(jt);ni.rotation.y=Math.PI/2;Jd();Ne.parent=jt;const Ba=new gx,Ce=new at;function Qd(){return jt.position.z*Math.tan(jt.fov*Math.PI/180/2)*(window.innerWidth/window.innerHeight)}Et.separation=1.5;Et.offset=2.3;Et.categoryWireSeparation=2.25;Et.wireThickness=.013;Et.pictureSize=1.2;Et.pinSize=.02;Et.tension=.4;Et.wireLength=Qd();Et.cameraLookRate=.015;Kr.add(Et,"separation",-5,5,.1).name("Separation");Kr.add(Et,"offset",-5,5,.1).name("Offset");Kr.add(Et,"pictureSize",.1,2,.1).name("Picture Size");Kr.add(Et,"tension",.1,2,.1).name("Tension");function sM(){vn=new Sn,vn.name="imageContainer";const r=new In(Et.pictureSize,Et.pictureSize*1.5),t=new Fr({color:"white",side:xn});va=new Ee(r,t),va.name="frame";const e=new In(Et.pictureSize/2,Et.pictureSize*1),n=new Fr({side:Jn});Tr=new Ee(e,n),Tr.name="picture",Tr.position.z=.02,vn.position.set(4,-ne.viewportHeight*2,0),vn.rotation.y=Math.PI/2,vn.add(va,Tr),vn.visible=!1,sn.add(vn)}async function aM(){const r=ve.children.find(t=>t.name.includes("picture"));Tr.material.map=r.material.map,Tr.geometry=r.geometry,va.geometry=ve.children.find(t=>t.name==="frame").geometry}sM();function oM(r,t,e){const n=new Sn,i=new Fr({color:0}),s=200,a=[];for(let d=0;d<=s;d++){const p=d/s,g=vi.lerp(t.x,e.x,p),_=vi.lerp(t.z,e.z,p),m=.5,f=t.y+Et.tension*-1*(1-4*(p-m)*(p-m));a.push(new D(g,f,_))}const o=new Fu(a),l=new rc(o,s,Et.wireThickness,8,!1),c=new Ee(l,i);c.geometry.computeBoundingBox(),c.castShadow=!0,c.name="categoryWire",n.add(c);const h=Math.sqrt((e.x-t.x)**2+(e.z-t.z)**2),u=Math.floor(h/Et.pictureSize);for(let d=0;d<r.length;d++){const p=new Sn,g=r[d];p.name=`picture-${_a}`,_a++;const _=1-d*Et.pictureSize/h-1/(2*u),m=o.getPointAt(_);console.log(`The t for picture ${d} is ${_} with pos ${JSON.stringify(m)}`);const f=new ic(Et.pinSize,16,16),x=new Fr({color:16711680}),v=new Ee(f,x);v.position.set(m.x,m.y,m.z),v.position.x+=.02;const y=new Sn,C=g.image.width,b=g.image.height;let A,R;C>b?(A=Et.pictureSize*.95,R=b/C*A):(R=Et.pictureSize*.95,A=C/b*R),y.name="imageContainer";const M=new In(A+Et.framePadding,R+Et.framePadding),S=new Ca({color:"white",side:xn,metalness:.2,roughness:.3}),L=new Ee(M,S);L.name="frame",L.castShadow=!0,L.position.z=.019;const z=new In(A,R);g.colorSpace=gn;const O=new Ca({map:g,metalness:.1,roughness:.1}),H=new Ee(z,O);H.name="picture"+_a,H.position.z=.02,y.add(H),y.add(L),y.position.set(m.x,m.y-.5*R,m.z),y.rotation.x=vi.degToRad(Math.random()*20-10),y.rotation.y=Math.PI/2,p.add(v),p.add(y),n.add(p)}return n}let xa=new Sn;function tf(r=!1){sn.remove(xa),xa=new Sn,Math.floor(2*Et.wireLength/Et.pictureSize);const t=Ec.length;lM(),kl=0,Fa=-((t-1)*Et.categoryWireSeparation),sn.add(xa),r&&gM(Fa)}function lM(){new yx().load("/fonts/helvetiker_regular.typeface.json",function(t){Ec.forEach((e,n)=>{const i=Et.offset-n*Et.categoryWireSeparation,s=Et.pictureSize*e.images.length,a=e.images.map(u=>$d[ga.findIndex(d=>d===u)]),o=oM(a,new D(0,i,-Math.max(s,Et.wireLength)),new D(0,i,Et.wireLength)),l=new xx(e.categoryName,{font:t,size:.2,height:.025,curveSegments:12,bevelEnabled:!0,bevelThickness:.01,bevelSize:.01,bevelSegments:3}),c=new Ca({color:"#30000a",metalness:.9,roughness:.1}),h=new Ee(l,c);h.position.set(0,i+.125,ne.viewportWidth/2*.96),h.rotation.y=Math.PI/2,sn.add(h),xa.add(o)})})}function cM(r){return new Promise((t,e)=>{new Yu().load(r,i=>{t(i)},void 0,i=>{e(i)})})}async function hM(){const t=await(await fetch("/images/images.json")).json();ga=t.imgList,Ec=t.categoryList;for(const e of ga){const n=`images/thumbnails/${e}`;try{const i=await cM(n);$d.push(i),console.log(`Loaded texture for ${e}`)}catch(i){console.error(`Error loading texture for ${e}:`,i)}}ga.length,tf(!0)}hM();function uM(){const r=document.getElementById("loadingScreen");r?(r.parentNode.removeChild(r),nn.to(Kd.uniforms.uAlpha,{duration:.5,value:0}),console.log("Loading screen removed")):console.log("Loading screen element not found")}const Ji=new Rv({canvas:Zy,antialias:!0});Ji.shadowMap.enabled=!0;Ji.shadowMap.type=ru;Ji.setSize(ne.width,ne.height);Ji.setPixelRatio(Math.min(window.devicePixelRatio,2));const dM=new _x,ef=()=>{dM.getElapsedTime(),!ve&&!Yr&&(vn.position.y=ni.position.y-ne.viewportHeight),Ji.render(sn,jt),window.requestAnimationFrame(ef)};function Tc(r){ve=r,aM(),zl=new D(r.position.x,r.position.y,r.position.z),mM(r,new D(jt.position.z/2,ni.position.y-ne.viewportHeight,0)),nf(!0)}function Ac(r){nf(!1),_M(r,zl),zl=void 0,ve=void 0}function fM(){console.log("Next Picture");const r=ve.parent.parent.children.find(t=>t.name===`picture-${parseInt(ve.parent.name.split("-")[1])+1}`).children.find(t=>t.name.includes("imageContainer"));r&&(Ac(ve),qa(r.parent.parent,-1,!0),setTimeout(()=>Tc(r),Et.animationSpeed*1e3))}function pM(){console.log("Previous Picture");const r=ve.parent.parent.children.find(t=>t.name===`picture-${parseInt(ve.parent.name.split("-")[1])-1}`).children.find(t=>t.name.includes("imageContainer"));r&&(Ac(ve),qa(r.parent.parent,1,!0),setTimeout(()=>Tc(r),Et.animationSpeed*1e3))}function mM(r,t){const e=new D;r.getWorldPosition(e);const n=new D(t.x,t.y,0);r.parent.worldToLocal(n),nn.to(r.position,{duration:Et.animationSpeed,x:n.x,y:n.y,z:n.z,ease:"power1.in"}),nn.to(r.rotation,{duration:Et.animationSpeed,x:0,y:r.rotation.y+(jt.position.z-e.z)/8,ease:"power3.in"})}function _M(r,t){nn.to(r.position,{duration:Et.animationSpeed,x:t.x,y:t.y,z:t.z,delay:Et.animationSpeed*.5,ease:"power1.out"}),nn.to(r.rotation,{duration:Et.animationSpeed,x:vi.degToRad(Math.random()*20-10),y:Math.PI/2,delay:Et.animationSpeed*.5,ease:"power3.out"})}function nf(r){Yr=!0;const t=vn.children.find(e=>e.name==="frame").geometry;nn.to(vn.position,{duration:Et.animationSpeed,x:r?jt.position.z-jd(t.parameters.width,t.parameters.height,95):0,y:r?ni.position.y:ni.position.y-ne.viewportHeight,ease:r?"power4.out":"power4.in",delay:r?Et.animationSpeed*.5:0}),setTimeout(()=>Yr=!1,Et.animationSpeed*1e3)}function gM(r){const t=new D(jt.position.x,jt.position.y,jt.position.z),e=jd(ne.viewportWidth,r,100)*10,n=(r-Et.offset)*.5;jt.position.z=e,jt.position.y=n,nn.to(jt.position,{duration:Et.animationSpeed*2,y:t.y,z:t.z,ease:"power4.out",delay:Et.animationSpeed*2,onStart:()=>{uM()},onComplete:()=>{vn.visible=!0}})}let zo=!1;function qa(r,t,e=!1){if(zo)return setTimeout(()=>qa(object),10);const n=r.children[0],i=Math.abs(n.geometry.boundingBox.max.z-n.geometry.boundingBox.min.z)/2,s=Math.min(Math.max(r.position.z-(e?Et.pictureSize:ne.viewportWidth)*t,0),2*i-ne.viewportWidth);return nn.to(r.position,{duration:Et.animationSpeed/2,z:s,ease:"elastic.out(1, 0.75)",onStart:()=>{zo=!0},onComplete:()=>{zo=!1},delay:e?Et.animationSpeed*.75:0}),nn.to(jt.rotation,{y:0,duration:Et.animationSpeed/2,ease:"power4.out"})}let ya=!1;function rf(r){if(ya)return setTimeout(()=>rf(r),10);const t=ni.position.y+r;if(t>kl||t<Fa)return console.log("Camera reached the end because new position is ",t,"camera min y is ",Fa," and camera max y is ",kl),nn.to(jt.rotation,{x:0,duration:Et.animationSpeed/2,ease:"power4.out"});nn.to(ni.position,{duration:Et.animationSpeed/2,y:t,ease:"power4.out",onStart:()=>{ya=!0},onComplete:()=>{ya=!1}}),nn.to(jt.rotation,{x:0,duration:Et.animationSpeed/2,ease:"power4.out"}),TM(r)}function vM(r){var t,e;return(e=(t=r.object.parent)==null?void 0:t.name)==null?void 0:e.includes("imageContainer")}function sf(r){if(ve)return Ac(ve);r.type==="touchend"?(Ce.x=r.changedTouches[0].clientX/window.innerWidth*2-1,Ce.y=-(r.changedTouches[0].clientY/window.innerHeight)*2+1):(Ce.x=r.clientX/window.innerWidth*2-1,Ce.y=-(r.clientY/window.innerHeight)*2+1),Ba.setFromCamera(Ce,jt);const e=Ba.intersectObjects(sn.children).filter(vM);if(e.length>0&&!Yr)return Tc(e[0].object.parent)}let qn,di,Ma;function nu(r){var n,i;if(ve)return;let t,e;if(r.type==="touchmove"?(t=r.changedTouches[0].clientX,e=r.changedTouches[0].clientY):(t=r.clientX,e=r.clientY),Ce.x=t/window.innerWidth*2-1,Ce.y=-(e/window.innerHeight)*2+1,qn&&Ls&&!di){const s=Math.abs(qn.x-Ce.x),a=Math.abs(qn.y-Ce.y);qn={x:Ce.x,y:Ce.y},di=s>a?"x":"y"}else if(di)if(di==="x"){Ba.setFromCamera(Ce,jt);const s=Ba.intersectObjects(sn.children);if(console.log("drag in progress x"),s.length>0&&((i=(n=s[0].object.parent)==null?void 0:n.name)!=null&&i.includes("imageContainer"))){Ma=s[0].object.parent.parent.parent;const a=qn.x-Ce.x;qn={x:Ce.x,y:Ce.y};const o=s[0].object.parent.parent.parent;o.position.z+=a*.5}}else{console.log("drag in progress y");const s=r.type==="touchmove"?r.changedTouches[0].clientY:r.clientY,a=s-Nn.y;Nn.y=s,SM(di,a)}else qn={x:Ce.x,y:Ce.y}}function af(r,t){if(di==="y")rf(Et.categoryWireSeparation*Math.sign(r));else if(!ve&&Ma)qa(Ma,Math.sign(t)),Ma=void 0;else return t<0?fM():pM()}let Nn={x:void 0,y:void 0},Ls=!1;function xM(r){Ls=!0,Ya=Date.now(),Wr=r.clientX,Xr=r.clientY,ve||(Nn.y=Xr,Nn.x=Wr)}function yM(r){const t=r.clientX,e=r.clientY,n=t-Wr,i=e-Xr,s=Math.sqrt(n*n+i*i);Date.now()-Ya<50||s<4||ve&&!Yr&&Math.abs(i)>Math.abs(n)?sf(r):af(i,n),Ls=!1,di=void 0,qn=void 0,Nn.y=null,Nn.x=null}function MM(r){Ls=!0,Ya=Date.now(),Wr=r.touches[0].clientX,Xr=r.touches[0].clientY,ve||(Nn.y=Xr,Nn.x=Wr)}function SM(r,t){if(!ya)return r==="y"?jt.rotateX(vi.degToRad(t*Et.cameraLookRate)):jt.rotateY(vi.degToRad(t*Et.cameraLookRate))}function EM(r){const t=r.changedTouches[0].clientX,e=r.changedTouches[0].clientY,n=t-Wr,i=e-Xr,s=Date.now()-Ya,a=Math.sqrt(n*n+i*i);console.log(a),s<100&&a<5||ve&&!Yr&&Math.abs(i)>Math.abs(n)?sf(r):af(i,n),Ls=!1,di=void 0,qn=void 0,Nn.y=null,Nn.x=null}function TM(r){Ne.target.position.y+=r}function AM(){return/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)}AM()?(window.addEventListener("touchstart",MM,!1),window.addEventListener("touchmove",nu,!1),window.addEventListener("touchend",EM,!1)):(window.addEventListener("mousedown",xM,!1),window.addEventListener("mousemove",nu,!1),window.addEventListener("mouseup",yM,!1));ef();
//# sourceMappingURL=index-C4q4MXpA.js.map
